...
exports.refreshAccessToken = exports.userLogout = exports.getAllUsers = exports.getLoggedUser = exports.userLogin = exports.userRegister = void 0;
...
const userRegister = async (req, res) => {
    try {
        const body = req.body;
        const payload = await validators_1.userRegisterValidator.validateAsync(body, {
            presence: "required",
        });
...
const userLogin = async (req, res) => {
    try {
        const body = req.body;
        const { email, password } = await validators_1.userLoginValidator.validateAsync(body, {
            presence: "required",
        });
...
const getAllUsers = async (req, res) => {
    try {
        ...
        const existingRequests = await db_config_1.default.friendRequests.findMany({
            where: {
        ...
        const availableUsers = await db_config_1.default.users.findMany({
            where: {
                id: {
